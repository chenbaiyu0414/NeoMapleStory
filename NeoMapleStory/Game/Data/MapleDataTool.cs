...
namespace NeoMapleStory.Game.Data
{
    public  class MapleDataTool
    {
        ...
        public static string GetString(IMapleData data, string def) => data == null || data.Data == null ? def : (string)data.Data;


        public static string GetString(string path, IMapleData data) => GetString(data.GetChildByPath(path));


        public static string GetString(string path, IMapleData data, string def)=> GetString(data.GetChildByPath(path), def);
        ...
        public static int ConvertToInt(IMapleData data) => data.GetType() == MapleDataType.String ? int.Parse(GetString(data)) : GetInt(data);
        ...
        {
            IMapleData pointData = data.GetChildByPath(path);
            if (pointData == null)
                return def;
